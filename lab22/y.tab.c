...
#line 1284 "y.tab.c" /* yacc.c:1646  */
  ...
  case 10:
#line 70 "lab22.y" /* yacc.c:1646  */
    { (yyval) = (yyvsp[-2]) * (yyvsp[0]); /*added semantic action for the gramar of multiplication */}
...
#line 84 "lab22.y" /* yacc.c:1646  */
    { (yyval) = regs[(yyvsp[0])]; if(debugsw) fprintf(stderr,"found a variable value: %d\n",(yyvsp[0])); /*added if statement for debug 01/16/2023*/}
#line 1328 "y.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 85 "lab22.y" /* yacc.c:1646  */
    {(yyval)=(yyvsp[0]); if(debugsw) fprintf(stderr,"found an integer: \n"); /*added if statement for debug 01/16/2023*/}
